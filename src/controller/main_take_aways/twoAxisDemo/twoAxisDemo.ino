...
// We have to declare the interrupt pins inside the code because we cannot 
// declare them in the class initialization. it wont work. 
// these are the isr function declarations
// in each isr call there is a function associated with the isr in the class. 
void isrEndstop01();
void isrEndstop00();
void isrEncoder0();
...
// unfortunately with how the pins are set-up for the portenta i couldn't figure out
// the pins data types requiring me to make two motor classes and two motor objects
Motor motorEl = Motor("El");
MotorTwo motorAz = MotorTwo("Az");

// just for demonstration purposes. will switch the direction of motor spins
int negative = -1;
