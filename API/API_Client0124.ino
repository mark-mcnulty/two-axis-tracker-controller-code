    ...
    while (client.connected()) {            // loop while the client's connected
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (currentLine.endsWith("GET")) {
          ...
          const char* state = doc["state"]; // "stowdfjhldsjfsejfjew"

          // Send to Controller
          // Recieve from controller
          // Read in data and flags

        }
        if (currentLine.endsWith("POST")) {
          //Get command and data from POST
          ...
          const char* state = doc["state"]; // "stowdfjhldsjfsejfjew"
          const char* data = doc["data"]; // "stowdfjhldsjfsejfjew"

          //Send to controller
          //Recieve from controller
          //read in flags and data
        }
